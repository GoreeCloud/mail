...
- Native Android build root and `:app` module proposed on this current-main-derived Draft branch; acceptance on `main` requires separate approval and post-merge verification.
