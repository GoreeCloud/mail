...
The model references GoreeCloud Identity Draft PR #9 exact Development candidate `d6f0f47aa98a9f1bce5b27df5bbf52da71950c30`, whose `goreecloud.identity.native-application-session/v1` source contract defines a non-secret consumer acceptance-proof shape.
